...
#ifndef H_BTPL_SCRIPT
#define H_BTPL_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBitcoinPlanetAddress
 */
...
public:
    ...
    // Pre-version-0.6, BitcoinPlanet always counted CHECKMULTISIGs
