...
/**
  BitcoinPlanet GUI main class. This class represents the main window of the BitcoinPlanet UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitcoinPlanetGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit BitcoinPlanetGUI(QWidget *parent = 0);
    ~BitcoinPlanetGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitcoinplanet wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
