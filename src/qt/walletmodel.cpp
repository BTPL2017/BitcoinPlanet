...
{
    CBitcoinPlanetAddress addressParsed(address.toStdString());
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(const QList<SendCoinsRecipient> &recipients, const CCoinControl *coinControl)
{
...

    {
        ...
        foreach(const SendCoinsRecipient &rcp, recipients)
        {
            ...
            scriptPubKey.SetDestination(CBitcoinPlanetAddress(rcp.address.toStdString()).Get());
...
{
    QString strAddress = QString::fromStdString(CBitcoinPlanetAddress(address).ToString());
...
void WalletModel::listCoins(std::map<QString, std::vector<COutput> >& mapCoins) const
{
    ...
    BOOST_FOREACH(const COutput& out, vCoins)
    {
        ...
        mapCoins[CBitcoinPlanetAddress(address).ToString().c_str()].push_back(out);
    }
}
